 ...
 */
class OwnerPropertiesManager extends PropertiesManager {
    ...
    OwnerPropertiesManager(Class<? extends Config> clazz, Properties properties, ScheduledExecutorService scheduler,
    ...
    private boolean equals(OwnerPropertiesManager that) {
    ...
    private boolean isAssignationCompatibleWith(OwnerPropertiesManager that) {
