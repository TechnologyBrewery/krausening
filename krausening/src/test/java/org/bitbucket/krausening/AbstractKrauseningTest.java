...
public abstract class AbstractKrauseningTest {
	...
	protected static final String WAR_1_PROPERTIES_SUBFOLDER = "/test-war-1";
	protected static final String WAR_2_PROPERTIES_SUBFOLDER = "/test-war-2";
	...
	protected Krausening getKrausening(String baseLocation, String extensionLocation) {
		return getKrausening(baseLocation, extensionLocation, NO_LOCATION, NO_LOCATION);
	}
	
	protected Krausening getKrausening(String baseLocation, String extensionLocation, String overrideLocation, String overrideSubfolder) {
        ...
        krausening.setOverrideExtensionsSubfolder(overrideSubfolder);
        return krausening;
    }
}
